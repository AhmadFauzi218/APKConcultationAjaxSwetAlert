            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="id_pertanyaan" id="id_pertanyaan2" class="form-control" type="text" placeholder="Id Pertanyaan" style="width:335px;" readonly autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="username" id="username2" class="form-control" type="text" placeholder="Username" style="width:335px;" required autocomplete="off" readonly>
                        </div>
                    </div>
